...
export const ProductCategoryImages = [
    {
        id:0,
        classProp: "relative col-span-3 row-span-6 max-md:col-span-1 max-md:row-span-1 max-md:p-4",
        buttonMessage: "Clothes",
        src: clothes
    },
    {
        id:1,
        classProp: "relative col-span-2 row-span-6 col-start-4 max-md:col-span-1 max-md:row-span-1 max-md:p-4 ",
        buttonMessage: "Electronics",
        src: electronics,
    },
    {
        id:2,
        classProp: "relative col-span-2 row-span-3 col-start-6 max-md:col-span-1 max-md:row-span-1 max-md:p-4",
        buttonMessage: "Toys",
        src: toys
    },
    {
        id:3,
        classProp:"relative col-span-2 row-span-3 col-start-6 row-start-4 max-md:col-span-1 max-md:row-span-1 max-md:p-4",
